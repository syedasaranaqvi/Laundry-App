...
import { getProducts } from '../components/ProductReducer';
    ...
    const checkIfLocationEnabled = async () => {
        ...
        if (!enabled) {
            Alert.alert(
                ...
                'Please Enbale The Location Services',
                [
                    {
                        text: 'Cancel',
            ...
            <ScrollView style={{ backgroundColor: "#F0F0F0", flex: 1, marginTop: 5 }}>
                ...
                <View style={{ flexDirection: "row", alignItems: "center", padding: 10 }}>
                    ...
                    <Pressable style={{ marginLeft: "auto", marginRight: 7 }}>
                        <Image style={{ width: 40, height: 40, borderRadius: 20 }} source={{ uri: "https://lh3.googleusercontent.com/ogw/AOLn63FwsB2zOUjepVnJQwk3dOvlhEWH5b6Qfqe9zxERwg=s32-c-mo" }} />
                    </Pressable>
                </View>
